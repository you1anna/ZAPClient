...
class importLogFiles(object):
    ...
    def post_mod_security_audit_event(self, auditeventstring='', apikey=''):
        ...
        This component is optional and therefore the API will only work if it is installed
        """
        return next(iter(self.zap._request(self.zap.base + 'importLogFiles/action/PostModSecurityAuditEvent/', {'AuditEventString' : auditeventstring, 'apikey' : apikey}).values()))
