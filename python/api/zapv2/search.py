...
class search(object):
    ...
    def urls_by_url_regex(self, regex, baseurl=None, start=None, count=None):
        ...
        if count is not None:
            params['count'] = count
        return next(iter(list(self.zap._request(self.zap.base + 'search/view/urlsByUrlRegex/', params).values())))
    ...
    def urls_by_request_regex(self, regex, baseurl=None, start=None, count=None):
        ...
        if count is not None:
            params['count'] = count
        return next(iter(list(self.zap._request(self.zap.base + 'search/view/urlsByRequestRegex/', params).values())))
    ...
    def urls_by_response_regex(self, regex, baseurl=None, start=None, count=None):
        ...
        if count is not None:
            params['count'] = count
        return next(iter(list(self.zap._request(self.zap.base + 'search/view/urlsByResponseRegex/', params).values())))
    ...
    def urls_by_header_regex(self, regex, baseurl=None, start=None, count=None):
        ...
        if count is not None:
            params['count'] = count
        return next(iter(list(self.zap._request(self.zap.base + 'search/view/urlsByHeaderRegex/', params).values())))
    ...
    def messages_by_url_regex(self, regex, baseurl=None, start=None, count=None):
        ...
        if count is not None:
            params['count'] = count
        return next(iter(list(self.zap._request(self.zap.base + 'search/view/messagesByUrlRegex/', params).values())))
    ...
    def messages_by_request_regex(self, regex, baseurl=None, start=None, count=None):
        ...
        if count is not None:
            params['count'] = count
        return next(iter(list(self.zap._request(self.zap.base + 'search/view/messagesByRequestRegex/', params).values())))
    ...
    def messages_by_response_regex(self, regex, baseurl=None, start=None, count=None):
        ...
        if count is not None:
            params['count'] = count
        return next(iter(list(self.zap._request(self.zap.base + 'search/view/messagesByResponseRegex/', params).values())))
    ...
    def messages_by_header_regex(self, regex, baseurl=None, start=None, count=None):
        ...
        if count is not None:
            params['count'] = count
        return next(iter(list(self.zap._request(self.zap.base + 'search/view/messagesByHeaderRegex/', params).values())))
