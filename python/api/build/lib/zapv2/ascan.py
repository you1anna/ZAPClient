...
class ascan(object):
    ...
    def status(self, scanid=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/view/status/', {'scanId' : scanid}).values()))

    def scan_progress(self, scanid=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/view/scanProgress/', {'scanId' : scanid}).values()))
    ...
    def scanners(self, scanpolicyname='', policyid=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/view/scanners/', {'scanPolicyName' : scanpolicyname, 'policyId' : policyid}).values()))

    def policies(self, scanpolicyname='', policyid=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/view/policies/', {'scanPolicyName' : scanpolicyname, 'policyId' : policyid}).values()))
    ...
    def scan(self, url, recurse='', inscopeonly='', scanpolicyname='', method='', postdata='', apikey=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/action/scan/', {'url' : url, 'recurse' : recurse, 'inScopeOnly' : inscopeonly, 'scanPolicyName' : scanpolicyname, 'method' : method, 'postData' : postdata, 'apikey' : apikey}).values()))
    ...
    def scan_as_user(self, url, contextid, userid, recurse='', scanpolicyname='', method='', postdata='', apikey=''):
        ...
        """
        return next(iter(self.zap._request(self.zap.base + 'ascan/action/scanAsUser/', {'url' : url, 'contextId' : contextid, 'userId' : userid, 'recurse' : recurse, 'scanPolicyName' : scanpolicyname, 'method' : method, 'postData' : postdata, 'apikey' : apikey}).values()))
    ...
    def enable_all_scanners(self, scanpolicyname='', apikey=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/action/enableAllScanners/', {'scanPolicyName' : scanpolicyname, 'apikey' : apikey}).values()))

    def disable_all_scanners(self, scanpolicyname='', apikey=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/action/disableAllScanners/', {'scanPolicyName' : scanpolicyname, 'apikey' : apikey}).values()))
    ...
    def set_policy_attack_strength(self, id, attackstrength, scanpolicyname='', apikey=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/action/setPolicyAttackStrength/', {'id' : id, 'attackStrength' : attackstrength, 'scanPolicyName' : scanpolicyname, 'apikey' : apikey}).values()))

    def set_policy_alert_threshold(self, id, alertthreshold, scanpolicyname='', apikey=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/action/setPolicyAlertThreshold/', {'id' : id, 'alertThreshold' : alertthreshold, 'scanPolicyName' : scanpolicyname, 'apikey' : apikey}).values()))

    def set_scanner_attack_strength(self, id, attackstrength, scanpolicyname='', apikey=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/action/setScannerAttackStrength/', {'id' : id, 'attackStrength' : attackstrength, 'scanPolicyName' : scanpolicyname, 'apikey' : apikey}).values()))

    def set_scanner_alert_threshold(self, id, alertthreshold, scanpolicyname='', apikey=''):
        return next(iter(self.zap._request(self.zap.base + 'ascan/action/setScannerAlertThreshold/', {'id' : id, 'alertThreshold' : alertthreshold, 'scanPolicyName' : scanpolicyname, 'apikey' : apikey}).values()))
