...
class OverviewPage(WorkspacePage):
    ...
    INVITE_MODAL = (By.CSS_SELECTOR,u'[data-automation="invitation-modal-btn"]')

    def __init__(self, driver):
        self.relative_url = u"/workspace/{1}"
...
class _OverviewTab(WorkspaceTabContent):
    ...
    def __init__(self, driver):
        super(_OverviewTab, self).__init__(driver, (By.ID, u"workspace-overview"))


class InviteModal(OverviewPage):

    EMAIL_ADDRESS_INPUT = (By.CSS_SELECTOR, u'[data-automation="component-pills"] input')
    ...
    def send_invites(self):
        self.click( (By.CSS_SELECTOR,u'[data-automation="submitButton"]'))
