...
class ActivationPage(HuddleBasePage):
	...
	ACTIVATION_CODE_FIELD = (By.CSS_SELECTOR, u'[data-automation="activationCode_field"]')
	ACTIVATION_BUTTON = (By.CSS_SELECTOR, u'[data-automation="activate_button"]')

	def __init__(self, driver):
		self.relative_url = u"/signup/activation.aspx"
