...
class AbstractPage(WebComponent):
	...
	def __init__(self, driver, url):
		...
		self.base_url = 'http://my.huddle.{0}'
	...
	def open(self, param=None):
		self.driver.get(str(self.get_page_url()).format(param))
		self.driver.maximize_window()
		return self

	def get_page_url(self):
		return str.format(self.base_url, self.driver._domain) + self.relative_url

	def wait_for_page_load(self, timeout=30):
		self.logger.debug("Waiting for page to load at {}.".format(self.driver.current_url))
